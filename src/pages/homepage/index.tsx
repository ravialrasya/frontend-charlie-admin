...
import { Bell, Eye, Building2, Clock, FilePlus } from "lucide-react";
...
const HomePage: React.FC = () => {
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      {/* Sidebar */}
      <aside className="w-55 bg-white shadow-md flex flex-col mt-5">
      ...
      {/* Teks di kanan */}
         ...
         <div className="-mt-9 -ml-5">
            <img src="/img/Screenshot__223_-removebg-preview.png" alt="Logo"  />
        ...
        <nav className="flex-1 px-4 py-6 space-y-4 text-sm">
          ...
          <Link to='/karyawan' className="flex items-center gap-2 text-gray-400 hover:text-blue-600 ">
      ...
      <div className="flex-1 flex flex-col ">
        {/* Header */}
        <header className="flex justify-end bg-white px-6 py-4 ">
          ...
          <div className="flex gap-4">
            ...
            <button className="rounded-full bg-blue-200 py-3 px-3">
