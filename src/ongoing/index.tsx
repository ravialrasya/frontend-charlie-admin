...
const TimeReportPage: React.FC = () => {
    ...
    // ✅ HELPER: route detail berdasarkan STATUS
    const getDetailPath = (status: OnGoing["status"], id: string) => {
        switch (status) {
            case "Menunggu":
                return `/proposal-advance/menunggu/${id}`;
            case "Disetujui":
                return `/proposal-advance/disetujui/${id}`;
            case "Ditolak":
                return `/proposal-advance/ditolak/${id}`;
            default:
                return "#";
        }
    };
                                    ...
                                    {filtered.map((r, i) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-3 text-center">
                                                <Link to={getDetailPath(r.status, r.id)}>
                                                    <img
                                                        src="/img/mdi_eye.png"
                                                        width={18}
